...
Fixpoint manual_gen_typ (size : nat) (stack1 : nat) : G Typ :=
  match size with
  | 0 => returnGen TBool
  | S size' =>
      let weight_tbool := match (size,(stack1)) with 
         | (1, (14)) => 500
         | (1, (15)) => 499
         | (2, (10)) => 500
         | _ => 500
...
Fixpoint manual_gen_expr (size : nat) (stack1 : nat) : G Expr :=
  match size with
  | 0 =>
      let weight_var := match (size,(stack1)) with 
         | (0, (11)) => 500
         | (0, (12)) => 500
         | (0, (13)) => 500
         | _ => 500
  ...
  | S size' =>
      ...
      let weight_boolean := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 501
      ...
      let weight_abs := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 500
      ...
      let weight_app := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 500
      ...
      (weight_var,
         ...
         let weight_1 := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 500
        ...
        (fun n1 : nat =>  
         let weight_2 := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 500
        ...
        (fun n2 : nat =>  
         let weight_4 := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 500
        ...
        (fun n4 : nat =>  
         let weight_8 := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 500
        ...
        (fun n8 : nat =>  
         let weight_16 := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 500
        ...
        (fun n16 : nat =>  
         let weight_32 := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 500
      ...
      (weight_boolean,
        let weight_true := match (size,(stack1)) with 
         | (1, (11)) => 500
         | (1, (12)) => 500
         | (1, (13)) => 500
         | (2, (11)) => 500
