  ...
  | S size' => 
    ...
    (
         ...
         | _ => 500
            ...
            bindGen (gen_Typ size' (stack2 : nat) 1)
                (fun p1 : Typ =>
bindGen (gen_Typ size' (stack2 : nat) 1)
                (fun p2 : Typ =>
  ...
  | 0 => 
    ...
    (
         ...
         | _ => 500
            ...
            bindGen (let weight_1 := match (size, ((stack1 : nat), (stack2 : nat))) with 
         | (0, (4, 4)) => 500
         | (0, (4, 5)) => 500
         | (0, (5, 4)) => 500
         | (0, (5, 5)) => 500
...
let weight_32 := match (size, ((stack1 : nat), (stack2 : nat))) with 
    ...
    (
         ...
         | _ => 500
            ...
            bindGen (let weight_true := match (size, ((stack1 : nat), (stack2 : nat))) with 
         | (0, (4, 4)) => 500
         | (0, (4, 5)) => 500
         | (0, (5, 4)) => 500
         | (0, (5, 5)) => 500
...
let weight_32 := match (size, ((stack1 : nat), (stack2 : nat))) with 
    ...
    (
         ...
         | _ => 500
            ...
            bindGen (gen_Typ size' (stack2 : nat) 4)
                (fun p1 : Typ =>
bindGen (gen_Expr size' (stack2 : nat) 4)
                (fun p2 : Expr =>
            returnGen (Abs p1 p2)
            ))
    )
    ...
    (
         ...
         | _ => 500
            ...
            bindGen (gen_Expr size' (stack2 : nat) 5)
                (fun p1 : Expr =>
bindGen (gen_Expr size' (stack2 : nat) 5)
                (fun p2 : Expr =>
            returnGen (App p1 p2)
